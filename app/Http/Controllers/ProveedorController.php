...
class ProveedorController extends Controller
{
    ...
    public function buscar(Request $request)
    {
        ...
        if(count($datos) == 0){
            $client = new nusoap_client(env('https://ws5.pide.gob.pe/services/ReniecConsultaDni?wsdl'),'wsdl');
            $result = $client->call("consultar", array('arg0' => array( "nuDniConsulta" => $request->dni,
                                                    'nuDniUsuario'          => env('43840691'),
                                                    'nuRucUsuario'          => env('20131365994'),
                                                    'password'              => env('43840691 '))));            
